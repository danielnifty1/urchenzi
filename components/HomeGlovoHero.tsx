...
export const HomeGlovoHero = ({ search, onSearchChange }: HomeGlovoHeroProps) => {
  ...
  return (
    <section className="relative left-1/2 w-screen max-w-[100vw] -translate-x-1/2 overflow-hidden px-4 pb-14 pt-8 dark:bg-gradient-to-b dark:from-surface dark:to-background md:pb-16 md:pt-10" style={{ backgroundColor: "var(--accent)" }}>
